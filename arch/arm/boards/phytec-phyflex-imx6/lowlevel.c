...
BAREBOX_IMD_TAG_STRING(phyflex_mx6_memsize_SZ_128M, IMD_TYPE_PARAMETER, "memsize=128", 0);
BAREBOX_IMD_TAG_STRING(phyflex_mx6_memsize_SZ_256M, IMD_TYPE_PARAMETER, "memsize=256", 0);
